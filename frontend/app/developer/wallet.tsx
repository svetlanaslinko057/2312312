      ...
      >
        ...
        {isOffline && (
          <View style={s.modeBadge} testID="payment-mode-badge">
            <Ionicons name="alert-circle" size={14} color={isMock ? '#F59E0B' : '#EF4444'} />
            <Text style={[s.modeBadgeText, { color: isMock ? '#F59E0B' : '#EF4444' }]}>
...
const s = StyleSheet.create({
  ...
  mockNotice: {
    color: '#F59E0B', fontSize: T.tiny, fontWeight: '700',
