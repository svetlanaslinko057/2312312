    ...
    <div className="max-w-4xl mx-auto space-y-8" data-testid="client-estimate-page">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#151922] p-6">
        ...
        <textarea
          ...
          className="w-full h-40 bg-black/30 border border-white/10 rounded-xl p-4 text-white placeholder:text-white/30 focus:outline-none focus:border-signal/30 resize-none"
      ...
      {(smartEstimate || estimate) && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {smartEstimate && (
            <div className="rounded-2xl border border-signal/30 bg-[#151922] p-6">
              <button
