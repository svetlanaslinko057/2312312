        ...
        <div className="rounded-3xl bg-card border border-border p-10 relative overflow-hidden">
          <div className="relative">
            ...
            <button
              ...
              className="group px-8 py-4 bg-signal hover:bg-signal-hover text-white font-semibold rounded-xl flex items-center gap-3 transition-all shadow-lg shadow disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {activeProject && (
        <section className="mb-8">
          ...
          <button
            ...
            className="w-full text-left rounded-2xl bg-[#151922] border border-border p-6 hover:border-signal/30 hover:bg-[#1a1f2a] transition-all group"
