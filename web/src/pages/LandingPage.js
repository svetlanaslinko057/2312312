 ...
 *   primary  = #0B8F5E  (deep mint, used for CTAs/text)
 *   accent   = #2FE6A6  (bright mint, glows only — never solid background)
 *   bg-app   = #FAFAFA
 *   card     = #FFFFFF, border #E5E7EB, shadow 0 4px 12px rgba(0,0,0,.04)
  ...
  <section className="relative pt-28 pb-20 sm:pt-32 sm:pb-28 overflow-hidden" data-testid="hero">
    ...
    <div className="relative max-w-7xl mx-auto px-6 sm:px-10 grid lg:grid-cols-12 gap-12 items-center">
      ...
      <div className="lg:col-span-6 space-y-7">
        ...
        >
          <span className="w-1.5 h-1.5 rounded-full" style={{ background: '#0B8F5E' }} />
        ...
        >
          Build real products
          <br />
          <span style={{ color: '#0B8F5E' }}>not tasks</span>
        </h1>
...
const PIPELINE_STEPS = [
  ...
  { key: 'scope', label: 'AI Scope', sub: '6 modules · $4,200', icon: Cpu, tint: '#0B8F5E' },
  { key: 'tasks', label: 'Tasks', sub: '24 tracked', icon: Workflow, tint: '#0B8F5E' },
  { key: 'dev', label: 'Dev', sub: '3 builders active', icon: GitBranch, tint: '#0B8F5E' },
  { key: 'qa', label: 'QA', sub: '12 / 12 verified', icon: ShieldCheck, tint: '#0B8F5E' },
  { key: 'ship', label: 'Delivery', sub: 'ready to ship', icon: CheckCircle2, tint: '#0B8F5E' },
];
    ...
    >
      ...
      <div className="flex items-center justify-between pb-4 mb-5 border-b border-border">
        ...
        <div className="flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: '#0B8F5E' }} />
        ...
        {PIPELINE_STEPS.map((s, i) => {
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  background: isActive
                    ...
                    ? 'rgba(11,143,94,0.12)'
                    : 'hsl(var(--muted))',
                  color: isActive ? '#fff' : isDone ? '#0B8F5E' : 'hsl(var(--muted-foreground))',
                }}
              >
              ...
              {isDone && <CheckCircle2 className="w-4 h-4" style={{ color: '#0B8F5E' }} />}
              {isActive && (
                <span
                  className="text-[10px] font-mono px-2 py-0.5 rounded-md"
                  style={{ background: '#0B8F5E', color: '#fff' }}
                >
                  RUNNING
                </span>
              )}
      ...
      <div className="flex items-center justify-between mt-5 pt-4 border-t border-border">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          <Activity className="w-3.5 h-3.5" style={{ color: '#0B8F5E' }} />
      ...
      <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {SYSTEM_CARDS.map((c) => {
          ...
          return (
            ...
            >
              {/* Hover glow accent — only here #2FE6A6 is allowed */}
              <div
                aria-hidden
                ...
                {g.chips.map((chip) => (
                  <span
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.color = '#0B8F5E';
                    }}
                    onMouseLeave={(e) => {
          ...
          return (
            ...
            >
              <div
                ...
                style={{ background: 'rgba(11,143,94,0.10)', color: '#0B8F5E' }}
              >
                <Icon className="w-4 h-4" />
              </div>
              <div
  ...
  >
    ...
    <div className="relative max-w-4xl mx-auto px-6 sm:px-10 text-center">
      ...
      >
        ...
        <br />
        A <span style={{ color: '#0B8F5E' }}>structured execution system</span>.
      </h2>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-2">
                <div
                  className="w-10 h-10 rounded-lg flex items-center justify-center"
                  style={{
                    background: isRecommended ? '#0B8F5E' : 'rgba(11,143,94,0.10)',
                    color: isRecommended ? '#fff' : '#0B8F5E',
                  }}
                >
                  <Icon className="w-5 h-5" />
                </div>
                ...
                {mode.points.map((p) => (
                  <li key={p} className="flex items-start gap-2.5 text-sm text-muted-foreground">
                    <Check
                      ...
                      style={{ color: '#0B8F5E', strokeWidth: 3 }}
                    />
                    <span>{p}</span>
                  </li>
                ))}
  ...
  >
    <div className="max-w-3xl mx-auto px-6 sm:px-10 text-center">
      ...
      >
        ...
        <span style={{ color: '#0B8F5E', fontWeight: 600 }}>3.5 weeks</span>. No
